...
const MyAddedProperties = () => {
    ...
    const handleDelete = async (property) => {
        try {
            ...
            const deleteResponse = await fetch(`http://localhost:5000/add-property/${id}`, {
                method: 'DELETE',
            });
        ...
        <div className="grid grid-cols-2 gap-10 mb-10">
            {propertyInfo && propertyInfo.map((property, index) => (
                <div key={index} className="flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md bg-gray-900 text-gray-100">
                    ...
                    <div>
                        <img src="/public/r1.png" alt="" className="object-cover w-full mb-4 h-36 sm:h-96 bg-gray-500" />
