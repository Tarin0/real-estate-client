...
const ReviewModal = ({ property }) => {
    ...
    const { user } = useAuth();
    const { name, title, email } = property;
    const handleSubmit = async e => {
        ...
        const dateString = currentDate.toLocaleDateString(); // Get date string
    ...
    return (
        <div className="my-12 grid justify-center">

            {/* Open the modal using document.getElementById('ID').showModal() method */}
            <button className="btn text-xl mt-5 px-6 py-2 border rounded-md bg-violet-400 text-gray-900 border-violet-400" onClick={() => document.getElementById('my_modal_5').showModal()}>Please Review</button>
                        ...
                        <div className="flex flex-col items-center w-full">
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="flex flex-col w-full">
                                    ...
                                    <textarea rows="3" name='description' placeholder="write your review" className="border border-gray-200 p-4 rounded-md resize-none text-gray-100 bg-gray-900"></textarea>
                                    <label className="text-white">Rating</label>
                                    <input
                                        name="rating"
                                        type="text"
                                        placeholder="Out of 5"
                                        className="border border-gray-200 p-4 rounded-md resize-none text-gray-100 bg-gray-900"
                                    />
