        ...
        <div>
            <section className="py-6 dark:bg-gray-800 dark:text-gray-100">
                <div className="container flex flex-col items-center justify-center p-4 mx-auto space-y-8 sm:p-10">
                    ...
                    <p className="max-w-2xl text-center dark:text-gray-400">Meet our dedicated team of professionals who are committed to helping you find your dream home. With years of experience and expertise, we strive to provide exceptional service and guidance throughout your real estate journey.</p>
                    <div className="flex flex-row flex-wrap-reverse justify-center">
                        ...
                        <div className="flex flex-col justify-center m-8 text-center">
                            ...
                            <p className="text-xl font-semibold leadi">Leroy Jenkins</p>
                            <p className="dark:text-gray-400">Product Designer</p>
                        </div>
                        <div className="flex flex-col justify-center m-8 text-center">
                            ...
                            <p className="text-xl font-semibold leadi">Leroy Jenkins</p>
                            <p className="dark:text-gray-400">Team lead</p>
                        </div>
                        <div className="flex flex-col justify-center m-8 text-center">
                        ...
                        <div className="flex flex-col justify-center m-8 text-center">
                            ...
                            <p className="text-xl font-semibold leadi">Leroy Jenkins</p>
                            <p className="dark:text-gray-400">Architecture</p>
                        </div>
                        <div className="flex flex-col justify-center m-8 text-center">
